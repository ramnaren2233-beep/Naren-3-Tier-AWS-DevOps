...
| Resource            | Details                      |
| ------------------- | ---------------------------- |
| **Elastic IP Name** | `NAT-Gateway-Elastic-IP`     |
...
| **Associated Subnet 1** | `subnet-07bbbd0d216953858` / `Naren-Web-Public-A` |
| **Associated Subnet 2** | `subnet-044b47da2d36ccf88` / `Naren-Web-Public-B` |
...
### 6.2 Private Application Route Table

| Resource                | Details                                            |
| ----------------------- | -------------------------------------------------- |
| **Route Table Name**    | `Naren-App-Private-RT`                             |
| **Route Table ID**      | `rtb-0ef2d3f5298cc3eb5`                            |
| **Associated Subnet 1** | `subnet-0bb4dc4133e76a9c1` / `Naren-App-Private-A` |
| **Associated Subnet 2** | `subnet-08e7db9cea295b3a4` / `Naren-App-Private-B` |
...
### 6.3 Private Database Route Table

| Resource                | Details                                           |
| ----------------------- | ------------------------------------------------- |
| **Route Table Name**    | `Naren-DB-Private-RT`                             |
| **Route Table ID**      | `rtb-0cd7e20df74b7bc7e`                           |
| **Associated Subnet 1** | `subnet-0dad776d0eb5fb9c6` / `Naren-DB-Private-A` |
| **Associated Subnet 2** | `subnet-03ebc86567f72a083` / `Naren-DB-Private-B` |
...
| ----------------------------------- | -------------------------------------------------- |
| **Public Route Table**              | `subnet-07bbbd0d216953858` / `Naren-Web-Public-A`  |
| **Public Route Table**              | `subnet-044b47da2d36ccf88` / `Naren-Web-Public-B`  |
| **Private Application Route Table** | `subnet-0bb4dc4133e76a9c1` / `Naren-App-Private-A` |
| **Private Application Route Table** | `subnet-08e7db9cea295b3a4` / `Naren-App-Private-B` |
| **Private Database Route Table**    | `subnet-0dad776d0eb5fb9c6` / `Naren-DB-Private-A`  |
| **Private Database Route Table**    | `subnet-03ebc86567f72a083` / `Naren-DB-Private-B`  |
